	...
	<div class="row">
		...
		<div class="row" style="padding:10px;">
			<div class="col-12">
					...
					$content = file_get_contents("https://www.omdbapi.com/?s=$title&type=movie&apikey=d476b9c2");
				...
				?>
					<div class="card-deck">
						<div class="card text-white bg-dark mb-3" style="min-width:200px;max-width:200px;float:left;">
							...
							<div class="card-body">
								<p class="card-text"><a href="profile.php?id=<?php echo $row['userID'] ?>" class="stretched-link" style="color:black;"><?php echo $row['username'] ?></a></p>	
							</div>
						</div>	
					</div>
